<template>
    <div>
        <div class="byte-input" :style="`transform: rotate(${rotate}deg);`" @dblclick="dblclick" @mousedown="mousedown">
...
function mousedown(event) {
    ...
    if (event.button == 1) {
        updateNodeData(props.id, { value: props.data.value + 1 > 255 ? 0 : props.data.value + 1 });
    }
}
</script>
